-- Fix save_project_atomic to handle partial updates correctly
-- by using COALESCE for numeric and date fields.
...
BEGIN
    ...
    ELSE
        ...
        INSERT INTO projects (
            ...
            kontraktor_name, manual_duration, labor_settings,
