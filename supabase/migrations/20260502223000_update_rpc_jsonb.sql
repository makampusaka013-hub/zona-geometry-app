-- =============================================================================
-- Migration: Update save_project_atomic to use JSONB instead of JSONB[]
-- This improves compatibility with PostgREST / Supabase JS client
-- =============================================================================

CREATE OR REPLACE FUNCTION public.save_project_atomic(
    p_project_id UUID,
    p_identity JSONB,
    p_lines JSONB, -- Changed from JSONB[] to JSONB
