  ...
  try {
    ...
    if (currentProjectId && allLines.length > 0) {
      const processedLines = allLines.map(l => ({
        id: (l.id && l.id.length > 10) ? l.id : undefined, // Pertahankan ID lama jika ada, biar DB yg buat baru jika undefined
        ...
        updated_by: user.id // WAJIB ADA untuk mematuhi RLS Supabase
      }));
