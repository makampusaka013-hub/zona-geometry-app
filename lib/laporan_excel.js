  ...
  worksheets.forEach(ws => {
    ...
    if ((isHarian || isMng || isBln) && !name.includes('DB_')) {
      ...
      if (isHarian) {
        ...
        ws.getCell('L7').value = { formula: `VLOOKUP($Q$1, db_harian_metadata!$A:$W, 3, FALSE)` };
        ws.getCell('L8').value = { formula: `VLOOKUP($Q$1, db_harian_metadata!$A:$W, 4, FALSE)` };
        ws.getCell('L9').value = { formula: `VLOOKUP($Q$1, db_harian_metadata!$A:$W, 5, FALSE)` };
