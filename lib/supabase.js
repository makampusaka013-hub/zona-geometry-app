...
export const supabase = createClient(
  ...
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY,
  {
    auth: {
      ...
      // HAPUS storage: window.localStorage agar sinkron dengan middleware (cookie)
    }
  }
);
...
// Unique ID for this browser tab/session to prevent realtime loops
export const clientId = typeof window !== 'undefined' 
  ? (window.name = window.name || crypto.randomUUID()) 
  : 'server';
