        ...
        Object.entries(categories).forEach(([catTitle, items], cIdx) => {
          ...
          items.forEach((line) => {
            ...
            if (wsHSP) {
              ...
              wsAHSP.getCell(`N${mainHeaderRow}`).value = { formula: `IFERROR(VLOOKUP(B${mainHeaderRow}, ahsp!B:N, 13, FALSE), "")`, result: Number(line.tkdn || line.total_tkdn_percent || 100) / 100 };
