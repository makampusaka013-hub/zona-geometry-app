...
const setupPrinter = (ws, companyName, printArea = null) => {
  ...
  // Footer Dinamis: Kiri (Waktu) & Kanan (Halaman)
    ...
    if (ws) {
      ...
      if (headerImageId !== null) {
        ws.addImage(headerImageId, {
          tl: { col: 0, row: 0 }, // Mulai dari pojok kiri atas A1
          br: { col: 9, row: 1 }, // Berakhir di batas bawah I1 (sudut J2)
          editAs: 'twoCell'
        });
      }
    }
