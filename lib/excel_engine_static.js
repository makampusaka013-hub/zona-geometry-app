        ...
        Object.entries(categories).forEach(([catTitle, items], cIdx) => {
          ...
          items.forEach((line) => {
            ...
            if (wsAHSP) {
              ...
              // 1. Ambil Profit Per-Item (Prioritas Mutlak dari Database profit_percent)
              ...
              // 2. Tulis ke Kolom L pada baris Uraian Pekerjaan
              wsAHSP.getCell(`L${mainHeaderRow}`).value = Number(smartProfit) / 100;
              wsAHSP.getCell(`L${mainHeaderRow}`).numFmt = '0.00%';
              wsAHSP.getCell(`L${mainHeaderRow}`).alignment = { vertical: 'middle', horizontal: 'center' };
