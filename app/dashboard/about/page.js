...
// ... (features array lines 15-52)
  ...
  return (
    <div className="min-h-full bg-slate-50 dark:bg-[#020617] p-6 lg:p-12 space-y-16 transition-colors duration-300">
      <div className="max-w-5xl mx-auto space-y-20">
        ...
        <section className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl lg:text-6xl font-black text-slate-900 dark:text-white leading-tight tracking-tight">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-amber-400 dark:to-orange-600 bg-clip-text text-transparent">Kecerdasan Data Konstruksi</span>
            </h1>
        ...
        <section className="bg-gradient-to-br from-blue-600 to-indigo-700 dark:from-indigo-950 dark:to-slate-950 rounded-[40px] p-12 lg:p-16 border border-white/10 text-center relative overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 dark:bg-amber-500/10 rounded-full -mr-48 -mt-48 blur-[100px]"></div>
          <div className="relative z-10 space-y-8">
            <h2 className="text-3xl font-black text-white">Standar Baru Efisiensi</h2>
            <p className="text-blue-50 dark:text-slate-300 text-lg lg:text-xl max-w-3xl mx-auto italic font-medium leading-relaxed">
            ...
            <div className="flex justify-center gap-4">
              <span className="px-5 py-2 rounded-full border border-white/20 bg-white/10 text-xs font-black text-white dark:text-amber-500 uppercase tracking-widest">
                Reliable
              </span>
              <span className="px-5 py-2 rounded-full border border-white/20 bg-white/10 text-xs font-black text-white dark:text-amber-500 uppercase tracking-widest">
                Accurate
          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900/60 backdrop-blur-2xl p-8 lg:p-10 rounded-[40px] border border-slate-200 dark:border-white/10 shadow-2xl space-y-8">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-4">Subjek Kendala</label>
                <input
                  required
                  type="text"
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/50 border-2 border-slate-100 dark:border-white/5 rounded-3xl px-8 py-5 text-slate-900 dark:text-white placeholder:text-slate-300 dark:placeholder:text-slate-700 outline-none focus:border-blue-500/50 dark:focus:border-amber-500/50 transition-all font-bold"
                />
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-4">Detail Laporan</label>
                <textarea
                  required
                  rows={5}
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/50 border-2 border-slate-100 dark:border-white/5 rounded-[32px] px-8 py-5 text-slate-900 dark:text-white placeholder:text-slate-300 dark:placeholder:text-slate-700 outline-none focus:border-blue-500/50 dark:focus:border-amber-500/50 transition-all font-bold resize-none"
                />
              </div>
            </div>
            ...
            <button
              ...
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-amber-500 dark:to-orange-600 hover:from-blue-500 hover:to-indigo-500 dark:hover:from-amber-400 dark:hover:to-orange-500 text-white dark:text-black py-6 rounded-[32px] font-black text-xl transition-all shadow-2xl shadow-blue-600/20 dark:shadow-amber-600/20 active:scale-95 disabled:opacity-50 flex items-center justify-center gap-4 group"
            >
              {isSubmitting ? (
                <>
                  <div className="w-6 h-6 border-4 border-white dark:border-black border-t-transparent animate-spin rounded-full"></div>
        ...
        <section className="bg-blue-600/5 dark:bg-slate-900/40 dark:backdrop-blur-md rounded-[32px] border border-blue-500/10 dark:border-amber-500/20 p-8 lg:p-12 text-center space-y-6">
          <div className="space-y-4">
            <h2 className="text-2xl font-black text-slate-900 dark:text-white">Ingin Kapasitas Lebih Besar?</h2>
            <p className="text-slate-500 dark:text-slate-400 font-medium">Buka akses proyek tak terbatas dan fitur Kolaborasi Premium (Advance).</p>
          </div>
          <a
            href="/dashboard/upgrade"
            className="inline-flex items-center gap-2 bg-blue-600 dark:bg-slate-800 hover:bg-blue-700 dark:hover:bg-slate-700 text-white px-8 py-4 rounded-2xl font-black tracking-widest uppercase transition-all shadow-lg active:scale-95 border border-transparent dark:border-white/5 dark:hover:border-amber-500/30"
          >
            Upgrade / Ganti Paket
            <svg className="w-5 h-5 text-blue-200 dark:text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="text-center pt-20 pb-10 flex flex-col items-center gap-4">
          ...
          <p className="text-slate-400 dark:text-slate-600 text-[10px] font-black uppercase tracking-[0.3em] opacity-50">
