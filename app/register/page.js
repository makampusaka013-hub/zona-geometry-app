  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 sm:p-6 overflow-hidden bg-[#f8fafc] dark:bg-slate-950">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[10%] left-[10%] w-[50%] h-[50%] rounded-full bg-indigo-500/10 dark:bg-indigo-600/10 blur-[120px] animate-pulse" />
        <div className="absolute bottom-[10%] right-[10%] w-[50%] h-[50%] rounded-full bg-rose-500/10 dark:bg-rose-600/10 blur-[120px] animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md my-4">
        <div className="text-center mb-4 sm:mb-6">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            Gabung dengan Zona Geometry hari ini
          </p>
        </div>

        {/* ── Glassmorphism Card ─────────────────────────────────── */}
        <div className="relative rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 p-5 sm:p-6 shadow-2xl backdrop-blur-2xl">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1 ml-1">
                Nama Lengkap
              </label>
              <input
                type="text"
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full h-12 mt-4 overflow-hidden rounded-xl bg-indigo-600 dark:bg-gradient-to-r dark:from-orange-500 dark:to-rose-500 font-bold text-white shadow-lg shadow-indigo-500/20 dark:shadow-orange-500/20 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest">
              <span className="bg-white dark:bg-[#0f172a] px-3 text-slate-400 dark:text-slate-500">Atau</span>
            </div>
          </div>
          ...
          <button
            ...
            className="group relative w-full h-11 flex items-center justify-center gap-3 overflow-hidden rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 font-bold text-slate-700 dark:text-white shadow-sm transition-all hover:bg-slate-50 dark:hover:bg-white/10 active:scale-[0.98] disabled:opacity-50"
          >
            {googleLoading ? (
          ...
          <div className="mt-6 text-center space-y-4">
            ...
            <Link
              href="/"
              className="inline-block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-slate-600 dark:text-slate-600 dark:hover:text-slate-400 transition-all"
            >
              ← Kembali ke Beranda
            </Link>
          </div>
